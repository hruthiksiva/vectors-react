  ...
  return (
    ...
    <div className="container-fluid hideOnDesktop py-5" style={{backgroundColor:'#f0eff2'}}>
      <div className="row px-3 d-flex justify-content-center">
        <div className="col-12 col-lg-3  rounded-4 border border-secondary my-5 me-3 p-4  porange" style={{minHeight:'350px',width: '21rem'}}>
        ...
        <div className="col-12 col-lg-3  rounded-4 border border-secondary my-5 me-3 p-4  pgreen" style={{minHeight:'350px',width: '21rem'}}>
        ...
        <div className="col-12 col-lg-3  rounded-4 border border-secondary my-5 me-3 p-4  pblue" style={{minHeight:'350px',width: '21rem'}}>
        ...
        <div className="col-12 col-lg-3  rounded-4 border border-secondary my-5 me-3 p-4  plightgreen" style={{minHeight:'350px',width: '21rem'}}>
    ...
    {/* VERSION 1 (bg-dark) */}
       {/* <div className='container-fluid py-5 my-5 bg-dark text-white'>
            <div className='row px-5'>
              <h1 className='pb-5' style={{fontSize:'', fontFamily:'arial'}}><span style={{col col-md-3 rounded-4 border border-secondary my-5 me-3 p-4 or:'#ffe6ca'}}>Services</span> We Provide</h1>
            </div>
           <div className='row px-5 py-3'>
             <div className='col col-md-3 rounded-4 border border-secondary my-5 me-3 p-4 -md-6 order-md-1 order-2 pe-5'>
             ...
             <div className='col col-md-3 rounded-4 border border-secondary my-5 me-3 p-4 -md-6 text-md-end order-md-2 order-1 text-center mb-md-0 mb-3'>
